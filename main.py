...
firstframe_path = r'C:/Users/Meghana/Downloads/abandoned-object-detection-master/video1.avi'

firstframe = cv2.imread(firstframe_path)
cap = cv2.VideoCapture(firstframe_path)
...
# location of video
file_path = r'C:/Users/Meghana/Downloads/abandoned-object-detection-master/video1.avi'
        ...
        if M['m00'] == 0:
            ...
            if cv2.contourArea(c) < 200 or cv2.contourArea(c) > 20000:
                ...
                countuniqueframe = set(
                    j for i, j in track_master)  # get a set of unique frameno. then len(countuniqueframe)
